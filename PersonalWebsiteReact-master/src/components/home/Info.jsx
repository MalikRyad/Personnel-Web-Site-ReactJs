...
const Info = () => {
  return (
    <div>
      ...
      <h1 className="name-tag">Malik Riad</h1>
      <h4 className="profession-tag">Senior Full Stack Developper</h4>
...
const links = {
  facebook: {
    url: "https://www.facebook.com/Ryad.malik",
    text: "Facebook profile"
  },
  linkedIn: {
    url: "https://www.linkedin.com/in/riad-malik-29022057/",
    text: "LinkedIn profile"
  },
  github: {
    url: "https://github.com/MalikRyad",
    text: "Github profile"
  }
};
export const other = {
  email: "malik_ryad@hotmail.fr",
